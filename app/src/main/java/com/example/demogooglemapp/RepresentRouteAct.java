...
public class RepresentRouteAct extends AppCompatActivity implements OnMapReadyCallback, GoogleMap.OnPolylineClickListener, GoogleMap.OnPolygonClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_represent_route);
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == REQUEST_CODE_PERMISSION) {
            if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(RepresentRouteAct.this, "Permission Denied", Toast.LENGTH_SHORT).show();
            }
        }
    }

    private void getRepresentRoute() {
    ...
    public void onPolylineClick(@NonNull Polyline polyline) {
        ...
        Toast.makeText(this, "Route type " + Objects.requireNonNull(polyline.getTag()),
    ...
    public void onPolygonClick(@NonNull Polygon polygon) {
        ...
        Toast.makeText(this, "Area type " + Objects.requireNonNull(polygon.getTag()), Toast.LENGTH_SHORT).show();
    }
